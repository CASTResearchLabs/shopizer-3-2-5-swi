...
- Ensure that any applications consuming the shipping-related endpoints are updated to handle the `ship_ASAP` field.
- Validate that these applications can process orders with the new shipping option.
