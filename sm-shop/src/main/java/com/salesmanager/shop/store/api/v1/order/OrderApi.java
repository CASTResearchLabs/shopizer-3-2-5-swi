...
public class OrderApi {
	...
	public ReadableOrderConfirmation checkout(
		...
		try {
			...
			Order modelOrder = orderFacade.processOrder(order, customer, shipments, merchantStore, language, locale);
	...
	public ReadableOrderConfirmation checkout(
		...
		try {
			...
			Order modelOrder = orderFacade.processOrder(order, customer, shipments, merchantStore, language,
